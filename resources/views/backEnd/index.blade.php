                        ...
                        <div id="myCarouse2" class="carousel vcarousel slide p-20">
                            ...
                            <div class="carousel-inner ">
                                <div class="active item">
                                    ...
                                    <div class="twi-user"><img src="{{ asset('backend/plugins/images/users/hritik.jpg') }}" alt="user" class="img-circle img-responsive pull-left">
                                ...
                                <div class="item">
                                    <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                                    <div class="twi-user"><img src="{{ asset('backend/plugins/images/users/genu.jpg') }}" alt="user" class="img-circle img-responsive pull-left">
                                        <h4 class="text-white m-b-0">Govinda</h4>
                                        <p class="text-white">Actor</p>
                                    </div>
                                </div>
                                <div class="item">
                                    <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                                    <div class="twi-user"><img src="{{ asset('backend/plugins/images/users/ritesh.jpg') }}" alt="user" class="img-circle img-responsive pull-left">
                                        <h4 class="text-white m-b-0">Govinda</h4>
                                        <p class="text-white">Actor</p>
                                    </div>
                                </div>
            ...
            <div class="white-box">
                ...
                <div class="comment-center">
                    <div class="comment-body">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/pawandeep.jpg') }}" alt="user" class="img-circle"></div>
                    ...
                    <div class="comment-body">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/sonu.jpg') }}" alt="user" class="img-circle"> </div>
                        <div class="mail-contnet">
                            <h5>Sonu Nigam</h5>
                    ...
                    <div class="comment-body">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/arijit.jpg') }}" alt="user" class="img-circle"> </div>
                        <div class="mail-contnet">
                            <h5>Arijit Sinh</h5>
        ...
        <div class="col-md-12 col-lg-4">
            <div class="white-box">
                ...
                <div class="message-center">
                    <a href="#">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/pawandeep.jpg') }}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                        <div class="mail-contnet">
                            <h5>Pavan kumar</h5>
                            <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                    </a>
                    <a href="#">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/sonu.jpg') }}" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                        <div class="mail-contnet">
                            <h5>Sonu Nigam</h5>
                            <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                    </a>
                    <a href="#">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/arijit.jpg') }}" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                        <div class="mail-contnet">
                            <h5>Arijit Sinh</h5>
                            <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                    </a>
                    <a href="#">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/genu.jpg') }}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                        <div class="mail-contnet">
                            <h5>Genelia Deshmukh</h5>
                            <span class="mail-desc">I love to do acting and dancing</span> <span class="time">9:08 AM</span> </div>
                    </a>
                    <a href="#" class="b-none">
                        <div class="user-img"> <img src="{{ asset('backend/plugins/images/users/pawandeep.jpg') }}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                        <div class="mail-contnet">
                            <h5>Pavan kumar</h5>
            ...
            <div class="white-box">
                ...
                <div class="chat-box">
                    <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                        <li>
                            <div class="chat-image"> <img alt="male" src="{{ asset('backend/plugins/images/users/sonu.jpg') }}"> </div>
                            <div class="chat-body">
                                <div class="chat-text">
                                    <h4>Sonu Nigam</h4>
                                    <p> Hi, All! </p>
                        ...
                        <li class="odd">
                            <div class="chat-image"> <img alt="Female" src="{{ asset('backend/plugins/images/users/genu.jpg') }}"> </div>
                            <div class="chat-body">
                                <div class="chat-text">
                                    <h4>Genelia</h4>
                        ...
                        <li>
                            <div class="chat-image"> <img alt="male" src="{{ asset('backend/plugins/images/users/ritesh.jpg') }}"> </div>
                            <div class="chat-body">
                                <div class="chat-text">
                                    <h4>Ritesh</h4>
...
<script src="{{ asset('backend/eliteadmin/js/custom.min.js') }}"></script>
    ...
    <script src="{{ asset('backend/eliteadmin/js/dashboard1.js') }}"></script>
    <!-- Sparkline chart JavaScript -->
    <script src="{{ asset('backend/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('backend/plugins/bower_components/jquery-sparkline/jquery.charts-sparkline.js') }}"></script>
